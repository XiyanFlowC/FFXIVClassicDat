...
void MainWindow::OnCommand(int id)
{
    ...
    {
        std::wstring msg = L"Game data path configuration will be available in a future update.\n\n"
            L"Current path: " + Config::GetInstance().m_ffxivInstallPath;
        MessageBoxW(m_hwnd, msg.c_str(),
            L"Config", MB_OK | MB_ICONINFORMATION);
        break;
    }
    case IDM_ABOUT:
